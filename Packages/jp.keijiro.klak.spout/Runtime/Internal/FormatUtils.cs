...
namespace Klak.Spout
{
    ...
    {
        public static (TextureFormat, bool isLinear) FromNativeFormat(DXGIFormat format)
        {
            switch (format)
            {
                case DXGIFormat.DXGI_FORMAT_R8G8B8A8_UNORM:
                    return (TextureFormat.RGBA32, true);
                case DXGIFormat.DXGI_FORMAT_R8G8B8A8_UNORM_SRGB:
                    return (TextureFormat.RGBA32, false);
                ...
                case DXGIFormat.DXGI_FORMAT_R32G32B32A32_FLOAT:
                    return (TextureFormat.RGBAFloat, true);
                case DXGIFormat.DXGI_FORMAT_R16G16B16A16_FLOAT:
                    return (TextureFormat.RGBAHalf, true);
                case DXGIFormat.DXGI_FORMAT_R32G32_FLOAT:
                    return (TextureFormat.RGFloat, true);
                case DXGIFormat.DXGI_FORMAT_R16G16_FLOAT:
                    return (TextureFormat.RGHalf, true);
                case DXGIFormat.DXGI_FORMAT_R32_FLOAT:
                    return (TextureFormat.RFloat, true);
